/**
 * Schritt Zusammenfassung – Kurzüberblick und nächste Schritte (Planvorschläge, Dokumente).
 */
...
function getHintActionFromWarning(warning: string, result: CalculationResult): { label: string; action: string | null } {
  ...
  if (warning.includes('Partnerschaftsbonus') || warning.includes('Partnerbonus'))
    return { label: 'Zum Monatsplan', action: 'focusMonatsplan' };
